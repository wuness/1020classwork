...
// grade weight constants
	...
	public static void main(String[] args) 	
	{
		...
		System.out.println("Hello my name is Garrett! I am currently a junior at MSU Denver"); // line 1
		System.out.println("I really enjoy listening to music it is my entire livelihood. I also quite enjoy very strange oddities.");
		System.out.println("My goals for life is to eventually make a comfortable living in ethical hacking. I have always been obsessed with hacks in general.");
		System.out.println("I am excited for what is to come in class! :)");
